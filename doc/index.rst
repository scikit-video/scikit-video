...
.. code-block:: console
    ...
    # v1.1.15 - PyPI upload in progress, install from GitHub:
    $ python -m pip install https://github.com/scikit-video/scikit-video/archive/refs/tags/v1.1.15.tar.gz
...
.. only:: html
   ...
   .. raw:: html  
    ...
    If you have any installation issues, consult the <a href='faq.html'>FAQ</a>. If you still have trouble, please report the issue on <a href='https://github.com/scikit-video/scikit-video/issues/new'>github</a>.
    <br/><br/>
	...
	<div class="container">
        ...
        <div class="col-md-5 menuitem">
            <img width=128 height=128 src="_static/loadsave.png"/>
            Reading and Writing Videos
        </div>
        </a>
        <a href='motion.html'>
        <div class="col-md-5 menuitem">
            <img width=128 height=128 src="_static/block.png"/>
