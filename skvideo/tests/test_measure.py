...
def test_measure_VideoBliinds():
    ...
    output = np.array([
      ...
      9.4895317005425905, 1.0096157789230347, 4.1325603858495361, 0.5859915107628374,
      0.5991939877061472, 0.5847040781244561, 0.5924675474802367, 0.5833441323353772,
