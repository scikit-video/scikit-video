...
# Travis clone scikit-video/scikit-video repository in to a local repository.
...
cd $HOME
if [ ! -d "skvideo_build_$NAME" ]; then
    mkdir skvideo_build_$NAME
fi
...
# Build scikit-video in the install.sh script to collapse the verbose
